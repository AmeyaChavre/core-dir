...
if (stateName in cityData)
{

      for (let i = 0; i < cityData[stateName].length ;i++)
      {
                  //console.log(stateName);
                  //stores individual cities in variable
                  let cityString=[];
                  cityString += (cityData[stateName][i]);                
